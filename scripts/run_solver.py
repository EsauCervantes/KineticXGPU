...
def make_common_metadata(config, q, endpoints, lam_self=None, run_name=None):
    ...
    metadata = {
        ...
        "heun_project_source_moments": bool(heun.get("project_source_moments", False)),
        "heun_record_raw_diagnostics": bool(heun.get("record_raw_diagnostics", False)),
        "heun_self_diagnostics": bool(heun.get("self_diagnostics", False)),
        "heun_diagnostics_every": int(heun.get("diagnostics_every", 1)),
    }
